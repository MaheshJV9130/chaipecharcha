...
const LearnAbout = () => {
  return (
    <section className="text-center my-5">
      <h3 className="text-2xl font-bold p-2">Learn More About Us</h3>
      <p className="text-xs md:text-[18px] font-light leading-6">
        ...
        of collective support. By providing a platform for patrons to
        contribute, we aim to transform dreams into reality and foster a culture
